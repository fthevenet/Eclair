...
namespace Microsoft.Experimental.IO {
    ...
    /// <summary>
    ///     Provides methods for creating, deleting, moving and enumeratingFiles directories and 
    ...
    internal static class LongPathDirectory {
        ...
        ///     does not have Windows or Code Access Security (CAS) permissions to read the directory.
        /// </remarks>
