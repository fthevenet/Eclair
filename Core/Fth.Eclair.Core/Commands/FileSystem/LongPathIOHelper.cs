//----------------------------------------------------------------------------- 
// <copyright file=LongPathIOHelper">
...
namespace Eclair.Commands.FileSystem
{
    ...
    /// <summary>
    /// An implementation of <see cref="IIOHelper"/> that uses Unicode version of the Win32 API to manipulate files and directories,
    /// alongside the use of the "\\?\" prefix, in order to bypass the limitation to 260 characters for paths to file system objects.
    /// </summary>
    public class LongPathIOHelper : IIOHelper
    {
        /// <summary>
        ...
        {
            return LongPath.IsPathRooted(path);
        }
        ...
        {
            return LongPath.ChangeExtension(path, extention);
        }
        ...
        {
            return LongPath.GetDirectoryPathNameFromFilePath(path);
        }
        ...
        {
            return LongPath.GetFileNameFromFilePath(path);
        }
        ...
        {
            return FailSafeFileBrowser.LongPathEnumerateFiles(path, searchPattern, errorHandler);
        }
