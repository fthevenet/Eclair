//----------------------------------------------------------------------------- 
// <copyright file=CommandSetupException">
...
namespace Eclair.Exceptions
{
    ...
    /// </summary>
    [Serializable]
    public class CommandSetupException : CommandLineInterpretationException
    {
        ...
        public CommandSetupException(ICommand command, string message)
            : base(message)
        {
        ...
        public CommandSetupException(ICommand command, string message, Exception innerException) 
        ...
        protected CommandSetupException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
            : base(info, context)
        {
        }
